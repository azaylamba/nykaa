...
You have to design & build the backend for the application and the ability for the users to register, add items to cart, check prices and place orders.
...
https://github.com/azaylamba/nykaa 
